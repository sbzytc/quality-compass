...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Integrations
    'integrations.resend.name': 'Email Notifications (Resend)',
    'integrations.resend.description': 'Send email notifications, invitations, and password resets via Resend',
    'integrations.smtp.name': 'SMTP Email Server',
    'integrations.smtp.description': 'Connect your own SMTP server for sending emails',
    'integrations.googleAuth.name': 'Google Sign-In',
    'integrations.googleAuth.description': 'Allow users to sign in with their Google accounts',
    'integrations.microsoftAuth.name': 'Microsoft Sign-In',
    'integrations.microsoftAuth.description': 'Allow users to sign in with their Microsoft/Azure accounts',
    'integrations.twilio.name': 'SMS Notifications (Twilio)',
    'integrations.twilio.description': 'Send SMS notifications and OTP verification via Twilio',
    'integrations.whatsapp.name': 'WhatsApp Business',
    'integrations.whatsapp.description': 'Send WhatsApp notifications and messages to customers',
    'integrations.slack.name': 'Slack',
    'integrations.slack.description': 'Send alerts and updates to Slack channels',
    'integrations.telegram.name': 'Telegram Bot',
    'integrations.telegram.description': 'Send notifications via Telegram bot',
    'integrations.field.apiKey': 'API Key',
    'integrations.field.fromEmail': 'Sender Email',
    'integrations.field.host': 'Host',
    'integrations.field.port': 'Port',
    'integrations.field.username': 'Username',
    'integrations.field.password': 'Password',
    'integrations.field.clientId': 'Client ID',
    'integrations.field.clientSecret': 'Client Secret',
    'integrations.field.tenantId': 'Tenant ID',
    'integrations.field.accountSid': 'Account SID',
    'integrations.field.authToken': 'Auth Token',
    'integrations.field.phoneNumber': 'Phone Number',
    'integrations.field.phoneId': 'Phone Number ID',
    'integrations.field.webhookUrl': 'Webhook URL',
    'integrations.field.botToken': 'Bot Token',
    'integrations.field.chatId': 'Chat ID',
    ...
    'integrations.category.platforms': 'Platforms',
    ...
    'nav.clinic.branches': 'Branches & Rooms',
  ...
  ar: {
    ...
    'nav.integrations': 'الربط والتكاملات',
    
    // Integrations
    'integrations.resend.name': 'إشعارات البريد الإلكتروني (Resend)',
    'integrations.resend.description': 'إرسال إشعارات البريد والدعوات وإعادة تعيين كلمة المرور عبر Resend',
    'integrations.smtp.name': 'خادم بريد SMTP',
    'integrations.smtp.description': 'ربط خادم SMTP خاص بك لإرسال البريد الإلكتروني',
    'integrations.googleAuth.name': 'تسجيل دخول Google',
    'integrations.googleAuth.description': 'السماح للمستخدمين بتسجيل الدخول بحساباتهم في Google',
    'integrations.microsoftAuth.name': 'تسجيل دخول Microsoft',
    'integrations.microsoftAuth.description': 'السماح للمستخدمين بتسجيل الدخول بحساباتهم في Microsoft/Azure',
    'integrations.twilio.name': 'إشعارات SMS (Twilio)',
    'integrations.twilio.description': 'إرسال إشعارات SMS ورمز التحقق عبر Twilio',
    'integrations.whatsapp.name': 'واتساب للأعمال',
    'integrations.whatsapp.description': 'إرسال إشعارات ورسائل واتساب للعملاء',
    'integrations.slack.name': 'سلاك',
    'integrations.slack.description': 'إرسال التنبيهات والتحديثات إلى قنوات Slack',
    'integrations.telegram.name': 'بوت تيليجرام',
    'integrations.telegram.description': 'إرسال الإشعارات عبر بوت تيليجرام',
    'integrations.field.apiKey': 'مفتاح API',
    'integrations.field.fromEmail': 'بريد المرسل',
    'integrations.field.host': 'الخادم',
    'integrations.field.port': 'المنفذ',
    'integrations.field.username': 'اسم المستخدم',
    'integrations.field.password': 'كلمة المرور',
    'integrations.field.clientId': 'معرف العميل',
    'integrations.field.clientSecret': 'سر العميل',
    'integrations.field.tenantId': 'معرف المستأجر',
    'integrations.field.accountSid': 'معرف الحساب',
    'integrations.field.authToken': 'رمز المصادقة',
    'integrations.field.phoneNumber': 'رقم الهاتف',
    'integrations.field.phoneId': 'معرف رقم الهاتف',
    'integrations.field.webhookUrl': 'رابط Webhook',
    'integrations.field.botToken': 'رمز البوت',
    'integrations.field.chatId': 'معرف المحادثة',
    'integrations.category.all': 'الكل',
    'integrations.category.email': 'البريد الإلكتروني',
    'integrations.category.auth': 'المصادقة',
    'integrations.category.notifications': 'الإشعارات',
    'integrations.category.platforms': 'المنصات',
    ...
    'nav.clinic.branches': 'الفروع والغرف',
