...
export function AppSidebar() {
  ...
  return (
    <motion.aside
      ...
      className="h-screen shrink-0 p-3 pe-1 flex flex-col"
      style={{ direction }}
    >
      <div className={cn(
        ...
        <div className="flex items-center px-2 pb-2 border-b border-[rgba(255,255,255,0.12)]">
          <div className="flex items-center gap-3">
            <img
              ...
              className="w-10 h-10 rounded-xl object-contain bg-white/80 ring-1 ring-emerald-900/5 shadow-sm"
            ...
            <AnimatePresence>
              {!collapsed && (
                ...
                >
                  <span className="font-bold text-[15px]" style={{ color: 'var(--rasdah-ink)' }}>
            ...
            <div className={cn("flex items-center gap-3 p-3 rounded-[20px]", collapsed ? "justify-center" : "")}>
              ...
              {!collapsed && (
                <div className="flex-1 min-w-0">
                  <p className="text-[14px] font-semibold truncate" style={{ color: 'var(--rasdah-ink)' }}>{profile.full_name}</p>
